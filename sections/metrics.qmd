...
The FWEI metrics are based on the Flood/Water Extraction Index. This index was developed to detect water and flooded areas using Sentinel 2 visible and near infrared bands [@farhadi2024fwei].
